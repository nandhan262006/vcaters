    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <a href="#form" className="hero-btn">GET IN TOUCH</a>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-left">
            <div className="section-title-row" style={{ justifyContent: "flex-start" }}>
              <img src="/justv.png" alt="" width={90} height={90} />
              <h2 style={{ fontFamily: "'Belgiano Serif', serif", fontSize: 28, fontWeight: 600, color: "#fff" }}>About Us</h2>
              <span className="section-title-line"><img src={`${ASSETS}/Group-32.svg`} alt="" width={200} height={5} style={{ filter: "brightness(0) invert(1)" }} /></span>
            </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-bottom-links">
            <button onClick={() => setShowPrivacy(true)} className="footer-credit" style={{ cursor: "pointer", border: "none", background: "none" }}>Privacy Policy</button>
            <button onClick={() => setShowTerms(true)} className="footer-credit" style={{ cursor: "pointer", border: "none", background: "none" }}>Terms &amp; Conditions</button>
          </div>
